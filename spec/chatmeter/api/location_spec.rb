...
RSpec.describe Chatmeter::API do
  ...
  context "Locations endpoint" do
    ...
    it "should return valid response for #update_location" do
      locations = chatmeter.update_location("location_id", {})
    ...
    it "should return valid response for #delete_location" do
      group = chatmeter.delete_location('23232')
      expect(group).to eq ""
    end
